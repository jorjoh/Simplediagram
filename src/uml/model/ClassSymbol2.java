 ...
 */
public class ClassSymbol2 extends Figuremodel {
		...
		public ClassSymbol2(int x, int y) {
			figureName = "Actor";
			start = new Point(x, y);
			...
			elements.add(new TextElement("ClassSymbol2", LabelAlign.BOTTOM));
		}

		protected Figuremodel instance(int x, int y) {
			return new ClassSymbol2(x, y);
		}
